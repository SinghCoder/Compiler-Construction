...
void insert_function_definition(st_wrapper *sym_table,char *lexeme, tree_node *inp_par_node_list, tree_node *outp_par_node_list, int def_line_num, int start_line_num, int end_line_num);
