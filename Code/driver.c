...
void print_menu() {
	...
	printf("4. Print abstract syntax tree for the program\n");
	printf("5. Print time taken for tokenizing and parsing\n");
	printf("6. Print first sets\n");
	printf("7. Print follow sets\n");
	printf("8. Construct Symbol table and type annotated AST\n");
	printf("9. Print IR and all symbol tables\n");
...
void populate_non_terminal_string() {
	...
	if (nt_file == NULL) {
		print_error("INTERNAL ERROR", "Parser init failed");
		exit(1);
	}
...
int main(int argc, char *argv[]) {
	...
	while (true) {
		...
		case 3: {
			...
			print_parse_tree_for_tool(ptr, pt);
		...
		case 4:
		{
			...
			printf("Number of abstract syntax tree nodes : %d\n", num_tree_nodes);
